...
#define DEFAULT_RPT_SIZE 2048*2*2*2*2*2
#define rdim 4096*2*2*2*2
#define cdim 4096*2*2
/* rpt defintion */
struct rpt_t {
  md_addr_t tag;
  md_addr_t prev_addr;
...
struct cache_t
{
  ...
  /* ECE552 Assignment 4 - BEGIN */
  struct rpt_t* rpt;
  md_addr_t ht[rdim][cdim];
  md_addr_t tag[rdim];
  int idx [rdim];
  md_addr_t prev_hist_addr;
  /* ECE552 Assignment 4- END */
